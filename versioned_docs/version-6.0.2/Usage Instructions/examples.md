...
- Log in to [http://localhost:3000](http://localhost:3000) (forms-flow-web) with valid user credentials for the designer.
...
- Log in to [http://localhost:3000](http://localhost:3000) (forms-flow-web) with valid default user credentials for the client.
...
- Log in to [http://localhost:3000](http://localhost:3000) (forms-flow-web) with valid default user credentials for the reviewer.
...
- Log in to [http://localhost:3000](http://localhost:3000) (forms-flow-web) with valid default user credentials for Clerk.
- After the login is successful you will be redirected to [http://localhost:3000/task](http://localhost:3000/task).
...
- Log in to [http://localhost:3000](http://localhost:3000) (forms-flow-web) with valid default user credentials for Approver.
- After the login is successful you will be redirected to [http://localhost:3000/task](http://localhost:3000/task).
