...
- Pull the latest version from [here](https://github.com/AOT-Technologies/forms-flow-ai/tree/master).
- Update the environment variables in the `.env` file located within the respective folders, as outlined below.
